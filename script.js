...
function game() {
   ...
   function reset() {
      playerFront.setAttribute('src', 'https://moussack.github.io/odin-rockPapperScissor/img/rps.svg');
      computerFront.setAttribute('src', 'https://moussack.github.io/odin-rockPapperScissor/img/rps.svg');
      playerScore = 0;
      computerScore = 0;
   ...
   function displayImage(result) {
      ...
      if (result.includes('Win') && result.includes('rock') && result.includes('scissor')) {
         ...
         playerFront.setAttribute('src', 'https://moussack.github.io/odin-rockPapperScissor/img/rock.svg');
         computerFront.setAttribute('src', 'https://moussack.github.io/odin-rockPapperScissor/img/scissor.svg');
      ...
      if (result.includes('Lose') && result.includes('rock') && result.includes('papper')) {
         ...
         playerFront.setAttribute('src', 'https://moussack.github.io/odin-rockPapperScissor/img/rock.svg');
         computerFront.setAttribute('src', 'https://moussack.github.io/odin-rockPapperScissor/img/papper.svg');
      ...
      if (result.includes('Tie') && result.includes('rock') && result.includes('rock')) {
         ...
         playerFront.setAttribute('src', 'https://moussack.github.io/odin-rockPapperScissor/img/rock.svg');
         computerFront.setAttribute('src', 'https://moussack.github.io/odin-rockPapperScissor/img/rock.svg');
      ...
      if (result.includes('Win') && result.includes('papper') && result.includes('rock')) {
         ...
         playerFront.setAttribute('src', 'https://moussack.github.io/odin-rockPapperScissor/img/papper.svg');
         computerFront.setAttribute('src', 'https://moussack.github.io/odin-rockPapperScissor/img/rock.svg');
      ...
      if (result.includes('Win') && result.includes('scissor') && result.includes('papper')) {
         ...
         playerFront.setAttribute('src', 'https://moussack.github.io/odin-rockPapperScissor/img/scissor.svg');
         computerFront.setAttribute('src', 'https://moussack.github.io/odin-rockPapperScissor/img/papper.svg');
